...
public class RestSimulatorTest {
   ...
   private static final String UNORDERED_NO_WILDCARD_XML = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><request><action>ADD</action><phonenumber>020960853</phonenumber><query>FIND</query><id>43206476111</id><channel>TS</channel><period>30</period><security>4107102958</security><response>verify.dtd</response><userid><password>pelle</password><username>pelle</username></userid><identity></identity></request>";
   private static final String ORDERED_NO_WILDCARD_XML = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><request><userid><username>pelle</username><password>pelle</password></userid><query>FIND</query><response>verify.dtd</response><channel>TS</channel><action>ADD</action><id>43206476111</id><identity></identity><period>30</period><security>4107102958</security><phonenumber>020960853</phonenumber></request>";
