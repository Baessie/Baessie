...
public class WSSimulatorTest {
	...
	public void executeTestWithBackReferences() throws Exception {
		...
		request.addParameter(WSSimulator.OUT_BACK_REFERENCES, "/y:response[1]/out[2]/text()[1]", "/y:response[1]/group[1]/out[1]/text()[1]", "/y:response[1]/group[1]/out[2]/text()[1]",
				"/y:response[1]/group[1]/out[3]/text()[1]");
